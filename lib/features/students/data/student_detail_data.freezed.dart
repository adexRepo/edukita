...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,studentNo,classId,nickName,fullName,joinAt,gender,status,className,schoolName,age,birthDate,nis,mobileNo,emailAddr,shoesSize,uniformSize,pantsSize,height,weight,photoPath]);

@override
String toString() {
  return 'StudentDetailData(id: $id, studentNo: $studentNo, classId: $classId, nickName: $nickName, fullName: $fullName, joinAt: $joinAt, gender: $gender, status: $status, className: $className, schoolName: $schoolName, age: $age, birthDate: $birthDate, nis: $nis, mobileNo: $mobileNo, emailAddr: $emailAddr, shoesSize: $shoesSize, uniformSize: $uniformSize, pantsSize: $pantsSize, height: $height, weight: $weight, photoPath: $photoPath)';
}
...
@useResult
$Res call({
 String id, String studentNo, String classId, String nickName, String fullName, String joinAt, Gender gender, StudentStatus status, String className, String schoolName, int age, String birthDate, String? nis, String? mobileNo, String? emailAddr, int? shoesSize, int? uniformSize, int? pantsSize, double? height, double? weight, String? photoPath
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String studentNo,  String classId,  String nickName,  String fullName,  String joinAt,  Gender gender,  StudentStatus status,  String className,  String schoolName,  int age,  String birthDate,  String? nis,  String? mobileNo,  String? emailAddr,  int? shoesSize,  int? uniformSize,  int? pantsSize,  double? height,  double? weight,  String? photoPath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StudentDetailData() when $default != null:
return $default(_that.id,_that.studentNo,_that.classId,_that.nickName,_that.fullName,_that.joinAt,_that.gender,_that.status,_that.className,_that.schoolName,_that.age,_that.birthDate,_that.nis,_that.mobileNo,_that.emailAddr,_that.shoesSize,_that.uniformSize,_that.pantsSize,_that.height,_that.weight,_that.photoPath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String studentNo,  String classId,  String nickName,  String fullName,  String joinAt,  Gender gender,  StudentStatus status,  String className,  String schoolName,  int age,  String birthDate,  String? nis,  String? mobileNo,  String? emailAddr,  int? shoesSize,  int? uniformSize,  int? pantsSize,  double? height,  double? weight,  String? photoPath)  $default,) {final _that = this;
switch (_that) {
case _StudentDetailData():
return $default(_that.id,_that.studentNo,_that.classId,_that.nickName,_that.fullName,_that.joinAt,_that.gender,_that.status,_that.className,_that.schoolName,_that.age,_that.birthDate,_that.nis,_that.mobileNo,_that.emailAddr,_that.shoesSize,_that.uniformSize,_that.pantsSize,_that.height,_that.weight,_that.photoPath);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String studentNo,  String classId,  String nickName,  String fullName,  String joinAt,  Gender gender,  StudentStatus status,  String className,  String schoolName,  int age,  String birthDate,  String? nis,  String? mobileNo,  String? emailAddr,  int? shoesSize,  int? uniformSize,  int? pantsSize,  double? height,  double? weight,  String? photoPath)?  $default,) {final _that = this;
switch (_that) {
case _StudentDetailData() when $default != null:
return $default(_that.id,_that.studentNo,_that.classId,_that.nickName,_that.fullName,_that.joinAt,_that.gender,_that.status,_that.className,_that.schoolName,_that.age,_that.birthDate,_that.nis,_that.mobileNo,_that.emailAddr,_that.shoesSize,_that.uniformSize,_that.pantsSize,_that.height,_that.weight,_that.photoPath);case _:
  return null;
...
class _StudentDetailData implements StudentDetailData {
  const _StudentDetailData({required this.id, required this.studentNo, required this.classId, required this.nickName, required this.fullName, required this.joinAt, required this.gender, required this.status, required this.className, required this.schoolName, required this.age, required this.birthDate, this.nis, this.mobileNo, this.emailAddr, this.shoesSize, this.uniformSize, this.pantsSize, this.height, this.weight, this.photoPath});
